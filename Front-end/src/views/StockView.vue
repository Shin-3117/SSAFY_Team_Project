...
<mian class="">
  ...
  <div v-if="Stock==='Kosdaq'" class="dark:bg-slate-800">
    <Kosdaq/>
  </div>
  <div v-if="Stock==='Krx'" class="dark:bg-slate-800">
    <Krx/>
  </div>
...
import Kospi from '@/components/Stock/Kospi.vue';
import Kosdaq from '@/components/Stock/Kosdaq.vue';
